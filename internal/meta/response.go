...
func (response VerifyResponse) IntoStored(
	...
	return VerifyResult{
		...
		CrawlerErrors:          sf.Map(crawlerDebug.CrawlerErrors, serializeMap),
		...
		Features:               serializeMap(response.DebugInfo.FeatureExtractorDebug.Features),
		MatchMaskDetails:       serializeMap(response.MatchMask.MatchMaskDetails),
